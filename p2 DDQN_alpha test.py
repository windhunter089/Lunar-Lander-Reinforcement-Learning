...
"""
"""
THIS PYTHON FILE FOCUS ON SENSITIVITY TEST OF LEARNING RATE ALPHA
"""
...
if __name__ == '__main__':
    ...
    plt.title('reward at each episode, alpha = 0.0003')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.alpha0.0003.png')
    # plt.show()
    plt.clf()
            
    # ALPHA = 0.001
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.001, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.01, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, alpha = 0.001')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.alpha0.001.png')
    # plt.show()
    plt.clf()

    # ALPHA = 0.01
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.01, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.01, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, alpha = 0.01')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.alpha0.01.png')
    # plt.show()
    plt.clf()

    # ALPHA = 0.1
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.1, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.01, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, alpha = 0.1')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.alpha0.1.png')
    # plt.show()
    plt.clf()

    # PLOT SUMMARY

    plt.plot(x, reward_SMA1, label = 'alpha = 0.0003', color = 'blue')
    plt.plot(x, reward_SMA2, label = 'alpha = 0.001', color = 'red')
    plt.plot(x, reward_SMA3, label = 'alpha = 0.01', color = 'green')
    plt.plot(x, reward_SMA4, label = 'alpha = 0.1', color = 'orange')
    plt.title('reward on learner with different alpha')
    plt.xlabel('Episode')
    plt.ylabel('Reward')
    plt.legend()
    plt.savefig('p2.alpha.summary.png')
    # plt.show()
    plt.clf()