...
"""
"""
THIS PYTHON FILE FOCUS ON SENSITIVITY TEST OF EPSILON RATE
"""
...
if __name__ == '__main__':
    ...
    plt.title('reward at each episode, epsilon = 0.01')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.epsilon0.01.png')
    # plt.show()
    plt.clf()
            
    # EPS = 0.05
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.0003, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.05, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, epsilon = 0.05')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.epsilon0.05.png')
    # plt.show()
    plt.clf()

    # EPSILON = 0.2
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.0003, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.2, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, epsilon = 0.2')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.epsilon0.2.png')
    # plt.show()
    plt.clf()

    # EPSILON = 0.5
    agent = Agent(gamma = 0.99, epsilon = 1.00, alpha = 0.0003, state_dim=[8],
                  action_dim = 4, batch_size = 64, eps_min= 0.5, eps_decay=0.001)
    reward_final = []
    ...
    plt.title('reward at each episode, epsilon = 0.5')
    plt.xlabel('episode')
    plt.ylabel('reward')
    plt.ylim(-500, 500)
    plt.grid(True)
    plt.savefig('p2.epsilon0.5.png')
    # plt.show()
    plt.clf()

    # PLOT SUMMARY

    plt.plot(x, reward_SMA1, label = 'epsilon = 0.01', color = 'blue')
    plt.plot(x, reward_SMA2, label = 'epsilon = 0.05', color = 'red')
    plt.plot(x, reward_SMA3, label = 'epsilon = 0.2', color = 'green')
    plt.plot(x, reward_SMA4, label = 'epsilon = 0.5', color = 'orange')
    plt.title('reward on learner with different epsilon')
    plt.xlabel('Episode')
    plt.ylabel('Reward')
    plt.legend()
    plt.savefig('p2.epsilon.summary.png')
    # plt.show()
    plt.clf()